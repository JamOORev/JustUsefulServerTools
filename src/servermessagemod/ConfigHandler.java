...
public class ConfigHandler {
    ...
    public static void configOptions(Configuration config) {
        ...
        colour = config.get(general, "What colour would you like your message to be?", "white").getString();
        format = config.get(general, "What format would you like your message to be?", "none").getString();
